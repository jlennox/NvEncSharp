...
void Nv12ToColor24(uint8_t* dpNv12, int nNv12Pitch, uint8_t* dpBgra, int nBgraPitch, int nWidth, int nHeight, int iMatrix) {
    ...
    YuvToRgbKernel<uchar2, COLOR24, uchar3>
...
template void Nv12ToColor32<ARGB32>(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight, int iMatrix);
