...
public partial struct NvEncoder
{
    ...
    public unsafe void GetEncodeGuids(Span<Guid> guids, out uint guidCount)
    {
        ...
        {
            var status = Fn.GetEncodeGuids(this, ptr, (uint)guids.Length, ref guidCount);
            CheckResult(this, status);
        }
    }
    ...
    public void GetEncodeProfileGuidCount(Guid encodeGuid, out uint encodeProfileGuidCount)
    {
        ...
        var status = Fn.GetEncodeProfileGuidCount(this, encodeGuid, ref encodeProfileGuidCount);
        CheckResult(this, status);
    }
    ...
    /// ::NV_ENC_ERR_INVALID_PARAM
    /// ::NV_ENC_ERR_GENERIC</returns>
    public unsafe void GetEncodeProfileGuids(Guid encodeGuid, Span<Guid> profileGuids, out uint guidCount)
    {
        guidCount = 0;
    ...
    {
        inputFmtCount = 0;
        var status = Fn.GetInputFormatCount(this, encodeGuid, ref inputFmtCount);
        CheckResult(this, status);
    }
    ...
    {
        var status = Fn.GetEncodeCaps(this, encodeGuid, ref capsParam, ref capsVal);
        CheckResult(this, status);
    }
    ...
    public void GetEncodePresetCount(Guid encodeGuid, out uint encodePresetGuidCount)
    {
        ...
        var status = Fn.GetEncodePresetCount(this, encodeGuid, ref encodePresetGuidCount);
        CheckResult(this, status);
    }
    ...
    {
        var status = Fn.GetEncodePresetConfig(this, encodeGuid, presetGuid, ref presetConfig);
        CheckResult(this, status);
    }
    ...
    public void GetEncodePresetConfigEx(
        Guid encodeGuid,
        Guid presetGuid,
        NvEncTuningInfo tuningInfo,
    ...
    public NvEncPresetConfig GetEncodePresetConfigEx(
        Guid encodeGuid,
        Guid presetGuid,
        NvEncTuningInfo tuningInfo = NvEncTuningInfo.HighQuality)
    {
        var presetConfig = new NvEncPresetConfig
        {
            Version = NV_ENC_PRESET_CONFIG_VER,
    ...
    {
        var status = Fn.CreateBitstreamBuffer(this, ref createBitstreamBufferParams);
        CheckResult(this, status);
    }
